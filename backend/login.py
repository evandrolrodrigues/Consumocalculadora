'''Ira ser feito a autenticação com a Moni
O usuario ira digitar o username e retornara o SessionID'''
import requests
import hashlib
...
if target_user:
    ...
    target_access_key_hash = hashlib.md5((challenge_token + target_accesskey).encode()).hexdigest()    
